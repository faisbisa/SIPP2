...
WebUI.click(findTestObject('Tambah TK belum ada BPJS/HitungIuran/klikNext'))
...
WebUI.scrollToElement(findTestObject('Tambah TK belum ada BPJS/HitungIuran/klikFinalisasi2'), 0)

WebUI.click(findTestObject('Tambah TK belum ada BPJS/HitungIuran/klikFinalisasi2'))

WebUI.click(findTestObject('Tambah TK belum ada BPJS/HitungIuran/klikYaFinalisasi'))
